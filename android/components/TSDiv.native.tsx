...
import { StyleProp, SafeAreaView, ScrollView, Text, TouchableOpacity, View } from 'android-native'
import unifiedBridge from '../../shared/unifiedBridge'
...
const tagComponentMap: Record<string, React.ComponentType<any>> = {
    ...
    // Block text elements (Text component in Android/iOS Native for text content)
    h1: Text,
    h2: Text,
    h3: Text,
    h4: Text,
